            ...
            <section>
                ...
                <div class="line">
                    ...
                    <div class="grupo-radio">
                            <input type="checkbox" name="doencas" value="1"/>
                            <Label>Catapora</Label>
                            <input type="checkbox" name="doencas" value="2"/>
                            <Label>Pneumonia</Label>
                            <input type="checkbox" name="doencas" value="3"/>
                            <Label>Cólera</Label>
                            <input type="checkbox" name="doencas" value="4"/>
                            <Label>Varíola</Label>
                            <input type="checkbox" name="doencas" value="5"/>
                            <Label>Renite</Label>
                            <input type="checkbox" name="doencas" value="6"/>
                            <Label>Meningite</Label>
                            <input type="checkbox" name="doencas" value="7"/>
                            <Label>Malária</Label>
                            <input type="checkbox" name="doencas" value="8"/>
                            <Label>Rubéola</Label>
                            <input type="checkbox" name="doencas" value="9"/>
                            <Label>Coqueluche</Label>
                            <input type="checkbox" name="doencas" value="10"/>
                            <Label>Bronquite</Label>
                            <input type="checkbox" name="doencas" value="11"/>
                            <Label>Hepatite</Label>
                            <input type="checkbox" name="doencas" value="12"/>
                            <Label>Febre Amarela</Label>
                            <input type="checkbox" name="doencas" value="13"/>
                            <Label>Sarampo</Label>
                            <input type="checkbox" name="doencas" value="14"/>
                            <Label>Difteria</Label>
                            <input type="checkbox" name="doencas" value="15"/>
                            <Label>Dengue</Label>
                            <input type="checkbox" name="doencas" value="16"/>
                            <Label>H1N1</Label>
                            <input type="checkbox" name="doencas" value="17"/>
                            <Label>Tétano</Label>
                            <input type="checkbox" name="doencas" value="18"/>
                            <Label>Caxumba</Label>
                    </div>
                </div>
                ...
                <div class="line">
                    ...
                    <div class="grupo-radio">
                        <input type="radio" name="cardiaco" onclick="hiddenElementOff('cardiaco_text')" value="1"/>
                        <Label>Sim</Label>
                        <input type="radio" name="cardiaco" onclick="hiddenElementOn('cardiaco_text')" value="0"/>
                        <Label>Não</Label>
                    </div>
                ...
                <div class="line">
                    ...
                    <div class="grupo-radio">
                        <input type="radio" name="alergia_medicamento" onclick="hiddenElementOff('alergia_medicamento_text')" value="1"/>
                        <Label>Sim</Label>
                        <input type="radio" name="alergia_medicamento" onclick="hiddenElementOn('alergia_medicamento_text')" value="0"/>
                        <Label>Não</Label>
                    </div>
                 ...
                 <div class="line">
                    ...
                    <div class="grupo-radio">
                        <input type="radio" name="lactose" onclick="hiddenElementOff('lactose_text')" value="1"/>
                        <Label>Sim</Label>
                        <input type="radio" name="lactose" onclick="hiddenElementOn('lactose_text')" value="0"/>
                        <Label>Não</Label>
                    </div>
                ...
                <div class="line">
                    ...
                    <div class="grupo-radio">
                        <input type="radio" name="deficiencia" onclick="hiddenElementOff('deficiencia_text')" value="1"/>
                        <Label>Sim</Label>
                        <input type="radio" name="deficiencia" onclick="hiddenElementOn('deficiencia_text')"  value="0"/>
                        <Label>Não</Label>
                    </div>
                ...
                <div class="line">
                    <p>Alergia na pele?</p>
                    <div class="grupo-radio">
                        <input type="radio" name="alergia_pele" onclick="hiddenElementOff('alergia_pele_text')" value="1"/>
                        <Label>Sim</Label>
                        <input type="radio" name="alergia_pele" onclick="hiddenElementOn('alergia_pele_text')" value="0"/>
                        <Label>Não</Label>
                    </div>
                ...
                <div class="line">
                    ...
                    <div class="grupo-radio">
                        <input type="radio" name="desmaio" onclick="hiddenElementOff('desmaio_text')" value="1"/>
                        <Label>Sim</Label>
                        <input type="radio" name="desmaio" onclick="hiddenElementOn('desmaio_text')" value="0"/>
                        <Label>Não</Label>
                    </div>
                ...
                <div class="line">
                    ...
                    <div class="grupo-radio">
                        <input type="radio" name="psicologicos" onclick="hiddenElementOff('psicologicos_text')" value="1"/>
                        <Label>Sim</Label>
                        <input type="radio" name="psicologicos" onclick="hiddenElementOn('psicologicos_text')" value="0"/>
                        <Label>Não</Label>
                    </div>
                ...
                <div class="line">
                    ...
                    <div class="grupo-radio">
                        <input type="radio" name="alergia" onclick="hiddenElementOff('alergia_text')" value="1"/>
                        <Label>Sim</Label>
                        <input type="radio" name="alergia" onclick="hiddenElementOn('alergia_text')" value="0"/>
                        <Label>Não</Label>
                    </div>
                 ...
                 <div class="line">
                    ...
                    <div class="grupo-radio">
                        <input type="radio" name="ferimento" value="1"/>
                        <Label>Sim</Label>
                        <input type="radio" name="ferimento" value="0"/>
                        <Label>Não</Label>
                    </div>
                </div>
                ...
                <div class="line">
                    ...
                    <div class="grupo-radio">
                        <input type="radio" name="fratura" onclick="hiddenElementOff('fratura_text')" value="1"/>
                        <Label>Sim</Label>
                        <input type="radio" name="fratura" onclick="hiddenElementOn('fratura_text')" value="0"/>
                        <Label>Não</Label>
                    </div>
                ...
                <div class="line">
                    ...
                    <div class="grupo-radio">
                        <input type="radio" name="cirurgia" onclick="hiddenElementOff('cirurgia_text')" value="1"/>
                        <Label>Sim</Label>
                        <input type="radio" name="cirurgia" onclick="hiddenElementOn('cirurgia_text')" value="0"/>
                        <Label>Não</Label>
                    </div>
                ...
                <div class="line">
                    <p>Fator RH</p>
                    <div class="grupo-radio">
                        <input type="radio" name="fator_rh" value="positivo"/>
